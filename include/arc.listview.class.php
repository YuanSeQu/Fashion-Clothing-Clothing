...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        {
            return "<li class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</li>\r\n";
        }
        $purl = $this->GetCurUrl();
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class=\"wow fadeInUp\">$j</span>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->TotalResult == 0)
        {
            return "<li class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</li>\r\n";
        }
        $maininfo = "<a class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</a>\r\n";
